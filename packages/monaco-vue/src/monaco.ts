...
export type MonacoRef = ShallowRef<Monaco | undefined>

export type CodeEditor = monaco.editor.IStandaloneCodeEditor
export type CodeEditorRef = ShallowRef<CodeEditor | undefined>

export type DiffEditor = monaco.editor.IStandaloneDiffEditor
export type DiffEditorRef = ShallowRef<DiffEditor | undefined>

export type ViewStatesMap = Map<string | undefined, monaco.editor.ICodeEditorViewState | null>
...
function createModel(monaco: Monaco, value: string, language?: string, path?: string) {
  let uri
  if (path !== undefined) {
    uri = createModelUri(monaco, path)
  }
